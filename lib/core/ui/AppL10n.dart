...
class AppL10n {
  ...
  static const Map<String, String> _ar = <String, String>{
    ...
    'operations_none': 'لا توجد عمليات بعد',
    'operations_running': 'قيد التشغيل',
    'operations_history': 'السجل',
    'operations_label': 'العمليات',
    'operations_clear_finished': 'مسح المكتملة',
    'bg_status_pending': 'قيد الانتظار',
    'bg_status_queued': 'في قائمة الانتظار',
    'bg_status_preparing': 'جارٍ التحضير',
    'bg_status_uploading': 'جارٍ الرفع',
    'bg_status_processing': 'جارٍ المعالجة',
    'bg_status_completed': 'مكتملة',
    'bg_status_failed': 'فشلت',
    'bg_status_cancelled': 'أُلغيت',
    'bg_status_retryWaiting': 'بانتظار إعادة المحاولة',
    'bg_tool_magic': 'المعالجة السحرية',
    'bg_tool_heal': 'معالجة المنطقة',
    'bg_tool_cleanEdges': 'تنظيف الحواف',
    'bg_tool_repairDamage': 'إصلاح التلف',
    'bg_tool_descratch': 'إزالة الخدوش',
    'bg_tool_background': 'تنظيف الخلفية',
    'bg_tool_expandCanvas': 'توسيع اللوحة',
    'blur_photo_result': 'نتيجة تمويه الصورة',
    'blur_photo_processing': 'جارٍ المعالجة',
    'blur_photo_close': 'إغلاق',
    'blur_photo_save': 'حفظ',
    'blur_photo_undo': 'تراجع',
    'blur_photo_redo': 'إعادة',
    'blur_photo_compare': 'مقارنة',
    'blur_photo_style': 'النمط',
    'blur_photo_shape': 'الشكل',
    'blur_mode_full': 'كامل',
    'blur_mode_smart': 'ذكي',
    'blur_mode_circle': 'دائري',
    'blur_mode_line': 'خطي',
    'blur_style_soft': 'ناعم',
    'blur_style_soft_desc': 'تمويه خلفية طبيعي',
    'blur_style_frost': 'ضبابي',
    'blur_style_frost_desc': 'تمويه زجاجي ساطع',
    'blur_style_motion': 'حركي',
    'blur_style_motion_desc': 'إحساس بسرعة اتجاهية',
    'blur_style_crystal': 'كريستالي',
    'blur_style_crystal_desc': 'انتقال حواف أكثر حدة',
    'blur_style_spotlight': 'إضاءة مركزية',
    'blur_style_spotlight_desc': 'تركيز ناعم في المنتصف',
    'blur_shape_circle': 'دائرة',
    'blur_shape_circle_desc': 'منطقة تركيز دائرية',
    'blur_shape_oval': 'بيضاوي',
    'blur_shape_oval_desc': 'تركيز أعرض في الوسط',
    'blur_shape_portrait': 'بورتريه',
    'blur_shape_portrait_desc': 'تركيز طولي على العنصر',
    'blur_shape_rectangle': 'مستطيل',
    'blur_shape_rectangle_desc': 'صندوق تمويه مستطيل',
    'blur_shape_tilt': 'إمالة',
    'blur_shape_tilt_desc': 'تركيز بخط أفقي',
    'blur_shape_vertical': 'عمودي',
    'blur_shape_vertical_desc': 'تركيز بخط عمودي',
    'blur_shape_diagonal': 'قطري',
    'blur_shape_diagonal_desc': 'تركيز بخط مائل',
    'perspective_result': 'نتيجة تصحيح المنظور',
    'perspective_auto_detect': 'كشف تلقائي بالذكاء الاصطناعي',
    'perspective_auto_detect_failed': 'تعذّر اكتشاف زوايا العنصر تلقائيًا.',
    'perspective_failed_image_data': 'فشل الحصول على بيانات الصورة',
    'perspective_error_prefix': 'خطأ: ',
    'perspective_reset': 'إعادة ضبط',
    'perspective_adjust': 'تطبيق',
    'perspective_discard': 'إلغاء',
    'perspective_extract_text': 'استخراج النص',
    'perspective_done': 'تم',
    'perspective_restart_required': 'مطلوب إعادة تشغيل',
    'perspective_restart_message': 'محرك OCR يحتاج إعادة تشغيل كاملة للتطبيق حتى يتهيأ. أوقف التطبيق وشغّله من جديد.',
    'ok': 'حسنًا',
    'perspective_no_text': 'لم يتم العثور على نص داخل الصورة.',
    'perspective_ocr_error_prefix': 'خطأ OCR: ',
    'perspective_text_sheet_title': 'النص المستخرج',
    'perspective_copy_text': 'نسخ النص',
    'perspective_text_copied': 'تم نسخ النص إلى الحافظة',
    'perspective_no_text_detected': 'لم يتم اكتشاف نص.',
    'perspective_title_select': 'حدد العنصر بلمس الزوايا أو عدّل الإطار يدويًا',
    'perspective_title_preview': 'المعاينة جاهزة. راجع النتيجة ثم احفظها',
    'copy_paste_result': 'نتيجة نسخ ولصق العناصر',
    'copy_paste_preparing_patch': 'جارٍ تجهيز القصاصة...',
    'copy_paste_target': 'الهدف',
    'copy_paste_source': 'المصدر',
    'copy_paste_preview': 'معاينة',
    'copy_paste_select': 'تحديد',
    'copy_paste_lasso': 'لاسو',
    'copy_paste_smart': 'ذكي',
    'copy_paste_people': 'أشخاص',
    'copy_paste_confirm': 'تأكيد',
    'copy_paste_copy': 'نسخ',
    'copy_paste_paste': 'لصق',
    'copy_paste_delete': 'حذف',
    'copy_paste_loading_source': 'جارٍ تحميل صورة المصدر...',
    'copy_paste_source_ready': 'صورة المصدر جاهزة. ارسم تحديدًا أو استخدم التحديد الذكي أو وضع الأشخاص.',
    'copy_paste_load_failed': 'تعذّر تحميل هذه الصورة.',
    'copy_paste_loading_target': 'جارٍ تحميل صورة الهدف...',
    'copy_paste_target_ready': 'صورة الهدف جاهزة. حدّد من المصدر ثم انسخ والصق داخل الهدف.',
    'copy_paste_smart_mode': 'تم تفعيل الوضع الذكي. اضغط على العنصر الذي تريد تحديده.',
    'copy_paste_people_mode': 'تم تفعيل وضع الأشخاص. اضغط على الشخص للحصول على تحديد أسرع.',
    'copy_paste_make_selection_larger': 'أنشئ تحديدًا أكبر ثم اضغط تأكيد أو نسخ.',
    'copy_paste_selection_ready': 'التحديد جاهز. حرّكه أو غيّر حجمه ثم اضغط تأكيد أو نسخ.',
    'copy_paste_import_first': 'أضف صورة أولًا.',
    'copy_paste_detecting_object': 'جارٍ اكتشاف العنصر...',
    'copy_paste_object_selected': 'تم تحديد العنصر. عدّل التحديد ثم اضغط تأكيد أو نسخ.',
    'copy_paste_smart_failed': 'فشل التحديد الذكي. حاول مرة أخرى أو استخدم التحديد اليدوي.',
    'copy_paste_detecting_person': 'جارٍ اكتشاف الشخص...',
    'copy_paste_person_selected': 'تم تحديد الشخص. عدّل التحديد ثم اضغط تأكيد أو نسخ.',
    'copy_paste_people_failed': 'فشل تحديد الشخص. اضغط مرة أخرى أو استخدم الوضع الذكي.',
    'copy_paste_create_selection_first': 'أنشئ تحديدًا أولًا.',
    'copy_paste_copying_selection': 'جارٍ نسخ التحديد...',
    'copy_paste_copied': 'تم النسخ. اضغط لصق لوضع معاينة ثم تأكيد للتطبيق.',
    'copy_paste_copy_failed': 'فشل نسخ التحديد الحالي.',
    'copy_paste_copy_first': 'انسخ شيئًا أولًا ثم اختر صورة الهدف.',
    'copy_paste_preview_placed': 'تم وضع المعاينة. حرّكها أو غيّر حجمها ثم اضغط تأكيد.',
    'copy_paste_paste_applied': 'تم تطبيق اللصق على الصورة المحددة.',
    'copy_paste_selection_deleted': 'تم حذف التحديد.',
    'copy_paste_selection_updated': 'تم تحديث التحديد. اضغط تأكيد أو نسخ عندما تكون جاهزًا.',
    'copy_paste_selection_confirmed': 'تم تأكيد التحديد. اضغط نسخ عندما تكون جاهزًا.',
    'copy_paste_preview_duplicated': 'تم تكرار المعاينة. اضغط تأكيد عندما تكون جاهزًا.',
    'copy_paste_layer_duplicated': 'تم تكرار الطبقة.',
    'copy_paste_preview_removed': 'تمت إزالة المعاينة.',
    'copy_paste_layer_deleted': 'تم حذف الطبقة.',
    'copy_paste_nothing_to_export': 'لا يوجد شيء للتصدير بعد.',
    'copy_paste_exporting': 'جارٍ تصدير التركيب...',
    'copy_paste_exported_gallery': 'تم التصدير إلى المعرض.',
    'copy_paste_export_complete': 'اكتمل التصدير.',
    'copy_paste_export_failed': 'فشل التصدير.',
    'clone_title_select': 'حدّد العنصر بلمسة أو بخط سريع',
    'clone_title_place': 'العنصر جاهز. اسحبه إلى المكان الجديد',
    'clone_guide_select': 'اضغط على العنصر مرة واحدة للتحديد الذكي، أو ارسم فوقه بشكل تقريبي.',
    'clone_guide_place': 'ظهر مربع أخضر حول العنصر. هذا يعني أن القص تم بنجاح وأن العنصر جاهز للتحريك.',
    'clone_loading': 'جارٍ تحديد العنصر',
    'clone_ready_move': 'تم القص بنجاح. العنصر جاهز للتحريك الآن.',
    'clone_tool_select': 'تحديد',
    'clone_tool_move': 'تحريك',
    'clone_tool_flip': 'قلب',
    'clone_tool_delete': 'حذف',
    'clone_harmonization': 'مواءمة الذكاء الاصطناعي',
    'clone_color_match': 'مطابقة اللون',
    'clone_blend_strength': 'قوة الدمج',
    'clone_edge_feather': 'نعومة الحواف',
    'style_transfer_home_title': 'نقل النمط بالذكاء الاصطناعي',
    'style_transfer_home_desc': 'استخرج نمطًا من أي مرجع، وكيّفه مع المشهد الهدف، ثم مرّره عبر محرك فيروسي سينمائي آمن.',
    'style_transfer_badge_scene_aware': 'واعٍ بالمشهد',
    'style_transfer_badge_face_safe': 'آمن للوجه',
    'style_transfer_badge_fast_preview': 'معاينة سريعة',
    'style_transfer_badge_high_res': 'تصدير عالي الدقة',
    'style_transfer_source_inputs': 'مدخلات المصدر',
    'style_transfer_reference_title': 'الصورة المرجعية',
    'style_transfer_reference_subtitle': 'تعلّم هذه الصورة المحرك مزاج اللون والمنحنيات وسلوك التفاصيل.',
    'style_transfer_pick_reference': 'اختر المرجع',
    'style_transfer_no_reference': 'لم يتم اختيار مرجع بعد',
    'style_transfer_target_title': 'الصورة الهدف',
    'style_transfer_target_subtitle': 'هذه هي الصورة التي ستتلقى النقل التكيفي.',
    'style_transfer_pick_target': 'اختر الهدف',
    'style_transfer_no_target': 'لم يتم اختيار صورة هدف بعد',
    'style_transfer_builtin_packs': 'حِزم الأنماط المدمجة',
    'style_transfer_tap_without_reference': 'اضغط للاستخدام بدون مرجع',
    'style_transfer_ready_launch': 'جاهز للانطلاق؟',
    'style_transfer_ready_launch_desc': 'اختر صورة هدف مع مرجع أو نمط جاهز، ثم أنشئ معاينة مباشرة.',
    'style_transfer_make_viral': 'اجعلها فيروسية',
  };
  ...
  static const Map<String, String> _en = <String, String>{
    ...
    'operations_none': 'No operations yet',
    'operations_running': 'Running',
    'operations_history': 'History',
    'operations_label': 'Operations',
    'operations_clear_finished': 'Clear Finished',
    'bg_status_pending': 'Pending',
    'bg_status_queued': 'Queued',
    'bg_status_preparing': 'Preparing',
    'bg_status_uploading': 'Uploading',
    'bg_status_processing': 'Processing',
    'bg_status_completed': 'Completed',
    'bg_status_failed': 'Failed',
    'bg_status_cancelled': 'Cancelled',
    'bg_status_retryWaiting': 'Waiting to retry',
    'bg_tool_magic': 'Magic Inpainting',
    'bg_tool_heal': 'Heal Region',
    'bg_tool_cleanEdges': 'Clean Edges',
    'bg_tool_repairDamage': 'Repair Damage',
    'bg_tool_descratch': 'Descratch Restore',
    'bg_tool_background': 'Background Cleanup',
    'bg_tool_expandCanvas': 'Expand Canvas',
    'blur_photo_result': 'Blur Photo Result',
    'blur_photo_processing': 'Processing',
    'blur_photo_close': 'Close',
    'blur_photo_save': 'Save',
    'blur_photo_undo': 'Undo',
    'blur_photo_redo': 'Redo',
    'blur_photo_compare': 'Compare',
    'blur_photo_style': 'Style',
    'blur_photo_shape': 'Shape',
    'blur_mode_full': 'Full',
    'blur_mode_smart': 'Smart',
    'blur_mode_circle': 'Circle',
    'blur_mode_line': 'Line',
    'blur_style_soft': 'Soft',
    'blur_style_soft_desc': 'Natural background blur',
    'blur_style_frost': 'Frost',
    'blur_style_frost_desc': 'Bright glassy blur',
    'blur_style_motion': 'Motion',
    'blur_style_motion_desc': 'Directional speed feel',
    'blur_style_crystal': 'Crystal',
    'blur_style_crystal_desc': 'Sharper edge transition',
    'blur_style_spotlight': 'Spotlight',
    'blur_style_spotlight_desc': 'Soft center emphasis',
    'blur_shape_circle': 'Circle',
    'blur_shape_circle_desc': 'Round focus area',
    'blur_shape_oval': 'Oval',
    'blur_shape_oval_desc': 'Wide center focus',
    'blur_shape_portrait': 'Portrait',
    'blur_shape_portrait_desc': 'Tall subject focus',
    'blur_shape_rectangle': 'Rectangle',
    'blur_shape_rectangle_desc': 'Rectangular blur box',
    'blur_shape_tilt': 'Tilt',
    'blur_shape_tilt_desc': 'Horizontal line focus',
    'blur_shape_vertical': 'Vertical',
    'blur_shape_vertical_desc': 'Vertical line focus',
    'blur_shape_diagonal': 'Diagonal',
    'blur_shape_diagonal_desc': 'Diagonal line focus',
    'perspective_result': 'AI Perspective Result',
    'perspective_auto_detect': 'AI Auto-Detect',
    'perspective_auto_detect_failed': 'Could not detect object corners automatically.',
    'perspective_failed_image_data': 'Failed to get image data',
    'perspective_error_prefix': 'Error: ',
    'perspective_reset': 'Reset',
    'perspective_adjust': 'Adjust',
    'perspective_discard': 'Discard',
    'perspective_extract_text': 'Extract Text',
    'perspective_done': 'Done',
    'perspective_restart_required': 'Restart Required',
    'perspective_restart_message': 'The OCR engine needs a full app restart to initialize. Please stop the app and run it again.',
    'ok': 'OK',
    'perspective_no_text': 'No text detected in the image.',
    'perspective_ocr_error_prefix': 'OCR Error: ',
    'perspective_text_sheet_title': 'Extracted Text',
    'perspective_copy_text': 'Copy text',
    'perspective_text_copied': 'Text copied to clipboard',
    'perspective_no_text_detected': 'No text detected.',
    'perspective_title_select': 'Select the object corners or adjust the frame manually',
    'perspective_title_preview': 'Preview ready. Review the result, then save it',
    'copy_paste_result': 'AI Object Copy Result',
    'copy_paste_preparing_patch': 'Preparing patch...',
    'copy_paste_target': 'Target',
    'copy_paste_source': 'Source',
    'copy_paste_preview': 'Preview',
    'copy_paste_select': 'Select',
    'copy_paste_lasso': 'Lasso',
    'copy_paste_smart': 'Smart',
    'copy_paste_people': 'People',
    'copy_paste_confirm': 'Confirm',
    'copy_paste_copy': 'Copy',
    'copy_paste_paste': 'Paste',
    'copy_paste_delete': 'Delete',
    'copy_paste_loading_source': 'Loading source image...',
    'copy_paste_source_ready': 'Source image ready. Draw a region, tap Smart, or use People for fast person selection.',
    'copy_paste_load_failed': 'Unable to load that image.',
    'copy_paste_loading_target': 'Loading target image...',
    'copy_paste_target_ready': 'Target image ready. Select on source, copy, then paste into target.',
    'copy_paste_smart_mode': 'Smart mode enabled. Tap the object you want to select.',
    'copy_paste_people_mode': 'People mode enabled. Tap the person for faster high-accuracy selection.',
    'copy_paste_make_selection_larger': 'Make a larger selection, then press Confirm or Copy.',
    'copy_paste_selection_ready': 'Selection ready. Move it, resize it, then press Confirm or Copy.',
    'copy_paste_import_first': 'Import an image first.',
    'copy_paste_detecting_object': 'Detecting object...',
    'copy_paste_object_selected': 'Object selected. Adjust it, then press Confirm or Copy.',
    'copy_paste_smart_failed': 'Smart selection failed. Tap again or use manual selection.',
    'copy_paste_detecting_person': 'Detecting person...',
    'copy_paste_person_selected': 'Person selected. Adjust it, then press Confirm or Copy.',
    'copy_paste_people_failed': 'People selection failed. Tap the person again or use Smart.',
    'copy_paste_create_selection_first': 'Create a selection first.',
    'copy_paste_copying_selection': 'Copying selection...',
    'copy_paste_copied': 'Copied. Press Paste to place a preview, then Confirm to apply.',
    'copy_paste_copy_failed': 'Copy failed for the current selection.',
    'copy_paste_copy_first': 'Copy something first, then choose a target image.',
    'copy_paste_preview_placed': 'Preview placed. Move or scale it, then press Confirm to apply.',
    'copy_paste_paste_applied': 'Paste applied to the selected image.',
    'copy_paste_selection_deleted': 'Selection deleted.',
    'copy_paste_selection_updated': 'Selection updated. Press Confirm or Copy when ready.',
    'copy_paste_selection_confirmed': 'Selection confirmed. Press Copy when ready.',
    'copy_paste_preview_duplicated': 'Preview duplicated. Press Confirm when ready.',
    'copy_paste_layer_duplicated': 'Layer duplicated.',
    'copy_paste_preview_removed': 'Preview removed.',
    'copy_paste_layer_deleted': 'Layer deleted.',
    'copy_paste_nothing_to_export': 'Nothing to export yet.',
    'copy_paste_exporting': 'Exporting composition...',
    'copy_paste_exported_gallery': 'Exported to gallery.',
    'copy_paste_export_complete': 'Export complete.',
    'copy_paste_export_failed': 'Export failed.',
    'clone_title_select': 'Select the object with a tap or quick stroke',
    'clone_title_place': 'Object ready. Drag it to the new position',
    'clone_guide_select': 'Tap the object once for smart selection, or sketch roughly over it.',
    'clone_guide_place': 'A green box appeared around the object. That means the cutout succeeded and it is ready to move.',
    'clone_loading': 'Detecting object',
    'clone_ready_move': 'Cutout complete. The object is ready to move now.',
    'clone_tool_select': 'Select',
    'clone_tool_move': 'Move',
    'clone_tool_flip': 'Flip',
    'clone_tool_delete': 'Delete',
    'clone_harmonization': 'AI Harmonization',
    'clone_color_match': 'Color Match',
    'clone_blend_strength': 'Blend Strength',
    'clone_edge_feather': 'Edge Feather',
    'style_transfer_home_title': 'AI Style Transfer',
    'style_transfer_home_desc': 'Extract a style from any reference, adapt it to your target scene, then push it through a cinematic safety-first viral engine.',
    'style_transfer_badge_scene_aware': 'Scene-aware',
    'style_transfer_badge_face_safe': 'Face-safe',
    'style_transfer_badge_fast_preview': 'Fast preview',
    'style_transfer_badge_high_res': 'High-res export',
    'style_transfer_source_inputs': 'Source Inputs',
    'style_transfer_reference_title': 'Reference image',
    'style_transfer_reference_subtitle': 'This image teaches the engine color mood, curves, and detail behavior.',
    'style_transfer_pick_reference': 'Pick reference',
    'style_transfer_no_reference': 'No reference selected yet',
    'style_transfer_target_title': 'Target image',
    'style_transfer_target_subtitle': 'This is the photo that will receive the adaptive transfer.',
    'style_transfer_pick_target': 'Pick target',
    'style_transfer_no_target': 'No target selected yet',
    'style_transfer_builtin_packs': 'Built-in Style Packs',
    'style_transfer_tap_without_reference': 'Tap to use without a reference',
    'style_transfer_ready_launch': 'Ready to launch?',
    'style_transfer_ready_launch_desc': 'Pick a target plus either a reference image or a trending preset, then generate a live preview.',
    'style_transfer_make_viral': 'Make it Viral',
  };
  ...
  String bgJobStatusName(String status) {
    switch (status) {
      case 'pending':
        return get('bg_status_pending');
      case 'queued':
        return get('bg_status_queued');
      case 'preparing':
        return get('bg_status_preparing');
      case 'uploading':
        return get('bg_status_uploading');
      case 'processing':
        return get('bg_status_processing');
      case 'completed':
        return get('bg_status_completed');
      case 'failed':
        return get('bg_status_failed');
      case 'cancelled':
        return get('bg_status_cancelled');
      case 'retryWaiting':
        return get('bg_status_retryWaiting');
      default:
        return status;
    }
  }

  String bgToolName(String toolType) {
    switch (toolType) {
      case 'magic':
        return get('bg_tool_magic');
      case 'heal':
        return get('bg_tool_heal');
      case 'cleanEdges':
        return get('bg_tool_cleanEdges');
      case 'repairDamage':
        return get('bg_tool_repairDamage');
      case 'descratch':
        return get('bg_tool_descratch');
      case 'background':
        return get('bg_tool_background');
      case 'expandCanvas':
        return get('bg_tool_expandCanvas');
      default:
        return toolType;
    }
  }
