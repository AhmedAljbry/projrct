part of 'repair_mask_assist_cubit.dart';

enum MaskGenerationStatus { idle, generating, ready, failure }

class RepairMaskAssistState extends Equatable {
  ...
  RepairMaskAssistState copyWith({
